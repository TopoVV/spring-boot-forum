...
public class PostController {
    ...
    public ResponseEntity<CreatePostResponse>
    createPost(@Valid @RequestBody CreatePostRequest createPostRequest, BindingResult bindingResult) {
        if(bindingResult.hasErrors()) {
            final CreatePostResponse response = new CreatePostResponse("Invalid input", bindingResult);
